...
func _run_population() -> void:
	...
	var payload: Dictionary = {
		...
		"top_bad_seeds": result.top_badness_seeds.size(),
		...
		"max_goal_friction_ratio": overall.get("max_goal_friction_ratio", {}),
		"max_consecutive_work_only_days": overall.get("max_consecutive_work_only_days", {}),
