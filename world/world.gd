...
func _feature_map() -> Dictionary:
	return {
		...
		&"restaurant": StoryTypes.StoryFeature.SOCIAL_ACCESS,
		&"park": StoryTypes.StoryFeature.SOCIAL_ACCESS,
		&"cinema": StoryTypes.StoryFeature.SOCIAL_ACCESS,
		&"arcade": StoryTypes.StoryFeature.SOCIAL_ACCESS,
		&"museum": StoryTypes.StoryFeature.SOCIAL_ACCESS,
		&"planetarium": StoryTypes.StoryFeature.SOCIAL_ACCESS,
