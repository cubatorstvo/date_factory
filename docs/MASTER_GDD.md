...
Venue — это toolkit. Место свидания не имеет общего quality/preference score. Его игровая ценность определяется Local Objects. Каждый Local Object предоставляет фиксированный набор тегированных ходов и расходуется целиком после одного использования за свидание.
