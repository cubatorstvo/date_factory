...
static func build(parent: Node3D, add_interact: Callable, box: Callable, label: Callable) -> Dictionary:
	...
	label.call(city, Vector3(-12, 3.2, 0), "Р“РћР РћР”")
...
static func _plaza(city: Node3D, add_interact: Callable, box: Callable, label: Callable, spots: Dictionary, waypoints: Array) -> void:
	...
	label.call(city, o + Vector3(0, 2.6, -3.5), "РџР»РѕС‰Р°РґСЊ")
	add_interact.call(city, o + Vector3(0, 0, 2.5), "РЎРєР°РјРµР№РєР°", "РћС‚РґРѕС…РЅСѓС‚СЊ (+РІРЅРёРјР°РЅРёРµ)", &"city_rest", {}, &"desk")
...
static func _corner_shop(city: Node3D, add_interact: Callable, box: Callable, label: Callable, spots: Dictionary, waypoints: Array) -> void:
	...
	box.call(city, Vector3(0.2, 2.8, 5), o + Vector3(2.9, 1.4, 0), Color(0.65, 0.5, 0.4))
	label.call(city, o + Vector3(0, 2.8, 0), "РњР°РіР°Р·РёРЅ В«РЈРіРѕР»РѕРєВ»")
	add_interact.call(city, o + Vector3(-1.2, 0, 0.5), "Р¦РІРµС‚С‹ СЃРѕ СЃРєРёРґРєРѕР№", "РљСѓРїРёС‚СЊ С†РІРµС‚РѕРє (в€’20%)", &"city_buy_gift", {"gift_id": "flower", "discount": 0.8}, &"shelf")
	add_interact.call(city, o + Vector3(1.2, 0, 0.5), "РљРѕРЅС„РµС‚С‹", "РљСѓРїРёС‚СЊ РєРѕРЅС„РµС‚С‹", &"city_buy_gift", {"gift_id": "candy", "discount": 0.9}, &"shelf")
...
static func _internet_cafe(city: Node3D, add_interact: Callable, box: Callable, label: Callable, spots: Dictionary, waypoints: Array) -> void:
	...
	box.call(city, Vector3(0.2, 2.6, 5), o + Vector3(3.4, 1.3, 0), Color(0.3, 0.32, 0.4))
	label.call(city, o + Vector3(0, 2.7, 0), "РРЅС‚РµСЂРЅРµС‚-РєР°С„Рµ")
	add_interact.call(city, o + Vector3(-1.5, 0, 0), "РџРљ в„–1", "РџРѕСЂР°Р±РѕС‚Р°С‚СЊ РѕРЅР»Р°Р№РЅ", &"city_cafe_job", {}, &"console")
	add_interact.call(city, o + Vector3(1.5, 0, 0), "РџРљ в„–2", "РЎРєСЂРѕР»Р»РёС‚СЊ (+РїРѕРїСѓР»СЏСЂРЅРѕСЃС‚СЊ)", &"city_cafe_scroll", {}, &"console")
	add_interact.call(city, o + Vector3(0, 0, -1.5), "РљРѕС„РµР№РЅСЏ", "РљСѓРїРёС‚СЊ РєРѕС„Рµ (+РІРЅРёРјР°РЅРёРµ)", &"city_coffee", {}, &"desk")
...
static func _park(city: Node3D, add_interact: Callable, box: Callable, label: Callable, spots: Dictionary, waypoints: Array) -> void:
	...
	label.call(city, o + Vector3(0, 2.6, -3), "РџР°СЂРє")
	add_interact.call(city, o + Vector3(0, 0, 1.5), "РЎРєР°РјРµР№РєР° РІ РїР°СЂРєРµ", "РџРѕСЃРёРґРµС‚СЊ", &"city_rest", {"bonus": 1.5}, &"desk")
	add_interact.call(city, o + Vector3(2, 0, -1), "РљРѕСЂРјСѓС€РєР°", "РџРѕРєРѕСЂРјРёС‚СЊ СѓС‚РѕРє (+в­ђ)", &"city_park_fun", {}, &"shelf")
...
static func _night_bar(city: Node3D, add_interact: Callable, box: Callable, label: Callable, spots: Dictionary, waypoints: Array) -> void:
	...
	label.call(city, o + Vector3(0, 2.8, 0), "РќРѕС‡РЅРѕР№ Р±Р°СЂ")
	add_interact.call(city, o + Vector3(-1, 0, 0.5), "Р‘Р°СЂРЅР°СЏ СЃС‚РѕР№РєР°", "Р’С‹РїРёС‚СЊ (в€’$ +СЃРєР°РЅРґР°Р»/в­ђ)", &"city_bar_drink", {}, &"desk")
	add_interact.call(city, o + Vector3(1.5, 0, 0.5), "РљР°СЂР°РѕРєРµ", "РЎРїРµС‚СЊ (+в­ђ +СЃРєР°РЅРґР°Р»)", &"city_karaoke", {}, &"console")
...
static func _bus_stop(city: Node3D, add_interact: Callable, box: Callable, label: Callable, spots: Dictionary, waypoints: Array) -> void:
	...
	box.call(city, Vector3(0.15, 1.6, 0.15), o + Vector3(1.6, 0.8, -1.2), Color(0.4, 0.4, 0.45))
	label.call(city, o + Vector3(0, 2.5, 0), "РћСЃС‚Р°РЅРѕРІРєР°")
	add_interact.call(city, o + Vector3(0, 0, 0.8), "Р Р°СЃРїРёСЃР°РЅРёРµ", "РџРѕСЃРјРѕС‚СЂРµС‚СЊ РјР°СЂС€СЂСѓС‚С‹", &"city_bus_info", {}, &"poster")
	add_interact.call(city, o + Vector3(1.5, 0, 0), "РђРІС‚РѕРјР°С‚", "РљСѓРїРёС‚СЊ СЃСѓРІРµРЅРёСЂ-РєРѕРЅС„РµС‚С‹", &"city_buy_gift", {"gift_id": "candy", "discount": 1.0}, &"machine")
