...
**Назначение:** применить `DatingResult` к постоянным отношениям девушки, ограничить шкалу `[-5,+5]`, реализовать повторные свидания, историю сыгранных событий, первое достижение `+5`, одноразовую Опытность/Баллы прокачки и интеграцию с Phone Journal  
