...
## 46.3. Кафе, ресторан и тематические места свиданий

Кафе (`cafe`) — безопасная ранняя площадка свиданий (donor-интерьер, качество `+1`).

Ресторан (`restaurant`) — отдельная локация из простых форм, не копия кафе; качество `+2`.

Тематические места свиданий (отдельные сцены из простых форм): парк, кинотеатр, аркада, музей, планетарий. Качество `+1` и проверка любимого формата досуга (`+1` / `-1`).

Квартира остаётся домашним свиданием; качество на этом этапе всегда `0`.

Полные правила бонусов: [`10_date_venues_outfits.md`](10_date_venues_outfits.md).
