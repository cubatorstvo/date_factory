...
| PE01-APT | df-scene-worker | complete — 66/66 physics, 18/18 visual, 9/9 collision debug | `world/locations/apartment/apartment.tscn`, `world/art/donor_import/apartment/apartment.tscn`, focused `world/test/**` | player, interactables, donor source | donor project, city/cafe, layout redesign |
