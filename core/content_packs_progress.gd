...
static func stages() -> Dictionary:
	return {
		"stage_1": {
			...
			"rooms": ["apartment", "neighbor_apt"], "venues": ["kitchen_table"],
			"girls": ["neighbor"],
		},
		"stage_2": {
			...
			"rooms": ["apartment", "neighbor_apt", "office_nook"], "venues": ["kitchen_table", "cheap_cafe", "park"],
		...
		"stage_5": {
			...
			"rooms": ["apartment", "neighbor_apt", "office_nook", "agency", "mansion", "factory"],
		...
		"stage_6": {
			...
			"rooms": ["apartment", "neighbor_apt", "office_nook", "agency", "mansion", "factory", "orbital"],
...
static func upgrades() -> Dictionary:
	...
	defs.append_array([
		...
		_u("venue_photo", "Фотостудия", "venues", 260, "stage_4", {"unlock_venue": "photo_studio"}),
