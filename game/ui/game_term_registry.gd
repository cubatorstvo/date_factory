...
func _ingest_system_terms() -> void:
	...
	_add_term(&"city_stage", "Этап города", "Уровень развития домашнего города. Открывает пачки filler-девушек и filler-соперников. Сюжетные цели зависят от этапа кампании и Рейтинга.", PackedStringArray(), GameTerm.Category.SYSTEM, GameTerm.Visual.ACCENT)
